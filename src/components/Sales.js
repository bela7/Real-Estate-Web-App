  ...
  render() {
    return (
      ...
      <div className="container">
        <div className="h-sales">Vânzări</div>
        <div id="apartamente">
        ...
        <div className="h3-sales">Apartamente</div>
          ...
          <div className="cards-container">
          <div className="card-sales">
            <img src={bedroom} alt="Living12" className="card-sales-img-top" />
            <div className="card-sales-body">
              <p
                className="card-sales-text"
                onClick={this.toggleApartamenteDescription}
        ...
        <div className="h3-sales">Garsoniere</div>
          <div className="cards-container">
          <div className="card-sales">
            <img src={studio3} alt="Studio3" className="card-sales-img-top" />
            <div className="card-sales-body">
              <p
                className="card-sales-text"
                onClick={this.toggleApartamenteDescription}
          ...
          <div className="cards-container">
          <div className="card-sales">
            <img src={studio6} alt="Studio6" className="card-sales-img-top" />
            <div className="card-sales-body">
              <p
                className="card-sales-text"
                onClick={this.toggleApartamenteDescription}
